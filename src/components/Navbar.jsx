            ...
            <div className="relative flex h-16 items-center">
              ...
              <div className="flex flex-1 items-center justify-around sm:items-stretch sm:justify-start ">
                ...
                <div className="absolute right-0 flex divide-x">
                  ...
                  <div className="px-2 flex space-x-4 justify-end">
                    <button
                      id="theme-toggle"
                      type="button"
                    ...
                    <button className="inline-flex items-center justify-center rounded-xl bg-gray-900 px-4 py-1.5 font-medium text-gray-50 hover:bg-gray-700 active:bg-gray-800">
                      Download Resume
                    </button>
                  </div>
                </div>
